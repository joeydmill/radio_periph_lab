...
xilinx.com:user:simple_axi_fifo_stream:1.0\
"
...
\
  ...
  # Create instance: simple_axi_fifo_stre_0, and set properties
  set simple_axi_fifo_stre_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:simple_axi_fifo_stream:1.0 simple_axi_fifo_stre_0 ]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins simple_axi_fifo_stre_0/S_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins full_radio_0/S00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins simple_axi_fifo_stre_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net s00_axi_aclk_0_1 [get_bd_ports clk125] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins full_radio_0/s00_axi_aclk] [get_bd_pins lowlevel_dac_intfc_0/clk125] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins xpm_cdc_gen_0/dest_clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins simple_axi_fifo_stre_0/s00_axi_aclk]
  connect_bd_net -net xpm_cdc_gen_0_dest_rst_out [get_bd_pins xpm_cdc_gen_0/dest_rst_out] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins full_radio_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins simple_axi_fifo_stre_0/s00_axi_aresetn]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs simple_axi_fifo_stre_0/S00_AXI/S00_AXI_reg] -force
